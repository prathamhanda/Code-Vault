...
// ==========================================
// 1. THE TEAMS LIST (30 Teams)
// ==========================================
const TEAMS_DATA = [
    { teamId: "mona-lisa", score: 1000, currentLevel: 1, violations: 0, isLocked: false },
    { teamId: "the-last-supper", score: 1000, currentLevel: 1, violations: 0, isLocked: false },
    { teamId: "starry-night", score: 1000, currentLevel: 1, violations: 0, isLocked: false },
    { teamId: "the-scream", score: 1000, currentLevel: 1, violations: 0, isLocked: false },
    { teamId: "guernica", score: 1000, currentLevel: 1, violations: 0, isLocked: false },
    { teamId: "las-meninas", score: 1000, currentLevel: 1, violations: 0, isLocked: false },
    { teamId: "composition-8", score: 1000, currentLevel: 1, violations: 0, isLocked: false },
    { teamId: "sunflowers", score: 1000, currentLevel: 1, violations: 0, isLocked: false },
    { teamId: "water-lilies", score: 1000, currentLevel: 1, violations: 0, isLocked: false },
    { teamId: "the-thinker", score: 1000, currentLevel: 1, violations: 0, isLocked: false },
    { teamId: "persistence", score: 1000, currentLevel: 1, violations: 0, isLocked: false },
    { teamId: "the-hay-wain", score: 1000, currentLevel: 1, violations: 0, isLocked: false },
    { teamId: "the-swing", score: 1000, currentLevel: 1, violations: 0, isLocked: false },
    { teamId: "no-5-1948", score: 1000, currentLevel: 1, violations: 0, isLocked: false },
    { teamId: "olympia", score: 1000, currentLevel: 1, violations: 0, isLocked: false },
    { teamId: "irises", score: 1000, currentLevel: 1, violations: 0, isLocked: false },
    { teamId: "nighthawk", score: 1000, currentLevel: 1, violations: 0, isLocked: false },
    { teamId: "the-gleaners", score: 1000, currentLevel: 1, violations: 0, isLocked: false },
    { teamId: "the-blue-boy", score: 1000, currentLevel: 1, violations: 0, isLocked: false },
    { teamId: "judith", score: 1000, currentLevel: 1, violations: 0, isLocked: false },
    { teamId: "ophelia", score: 1000, currentLevel: 1, violations: 0, isLocked: false },
    { teamId: "saturn", score: 1000, currentLevel: 1, violations: 0, isLocked: false },
    { teamId: "liberty", score: 1000, currentLevel: 1, violations: 0, isLocked: false },
    { teamId: "melancholia", score: 1000, currentLevel: 1, violations: 0, isLocked: false },
    { teamId: "venus", score: 1000, currentLevel: 1, violations: 0, isLocked: false },
    { teamId: "napoleon", score: 1000, currentLevel: 1, violations: 0, isLocked: false },
    { teamId: "salome", score: 1000, currentLevel: 1, violations: 0, isLocked: false },
    { teamId: "flora", score: 1000, currentLevel: 1, violations: 0, isLocked: false },
    { teamId: "the-dream", score: 1000, currentLevel: 1, violations: 0, isLocked: false },
    { teamId: "arnolfini", score: 1000, currentLevel: 1, violations: 0, isLocked: false }
];

// ==========================================
// 2. THE LEVELS LIST (7 Levels)
// ==========================================
const LEVELS_DATA = [
    {
        levelNumber: 1,
...
const seedDB = async () => {
    try {
        ...
        console.log(`✅ ${LEVELS_DATA.length} Levels Inserted.`);
